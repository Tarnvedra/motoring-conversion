...
<div class="container">
   ...
   <div class="row">
    ...
    <div class="row">
    <div class="d-flex pt-1">
        <div class="pr-5"><a href="{{url('/force')}}"><img src="img/force.svg" height="200" width="200"></a>
        <figcaption>Force</figcaption></div>
        <div class="pr-5"><a href="{{url('/pressure')}}"><img src="img/pressure.svg" height="200" width="200"></a>
        <figcaption>Pressure</figcaption></div>
        <div><a href="{{url('/torque')}}"><img src="img/torque.svg" height="200" width="200"></a>
    ...
    <div class="row">
    <div class="d-flex pt-1">
        <div class="pr-5"><a href="{{url('/power')}}"><img src="img/power.svg"height="200" width="200" ></a>
        <figcaption>Power</figcaption></div>
        <div class="pr-5"><a href="{{url('/velocity')}}"><img src="img/speed.svg" height="200" width="200"></a>
        <figcaption>Velocity</figcaption></div>
        <div><a href="{{url('/consumption')}}"><img src="img/fuel.svg" height="200" width="200"></a>
    ...
    <div class="row">
        <div class="d-flex pt-1">
            <div class="pr-5"><a href="{{url('/temperature')}}"><img src="img/temperature.svg" height="200" width="200"></a>
            <figcaption>Temperature</figcaption></div>
            <div class="pr-5"><a href="{{url('/electrical')}}"><img src="img/electrical.svg" height="200" width="200"></a>
            <figcaption>Electrical</figcaption></div>
            <div><a href="{{url('/retrieve')}}"><img src="img/retrieve.svg" height="200" width="200" ></a>
